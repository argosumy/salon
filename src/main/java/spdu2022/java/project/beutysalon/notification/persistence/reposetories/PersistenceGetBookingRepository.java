...
public class PersistenceGetBookingRepository implements GetBookingServiceRepository {
    ...
    public List<BookedService> getBookingBySalonId(long salonId) {
        final String sql = "SELECT salon_id, salon_name, salons.phone AS salon_phone, staff_id, " +
                "booking.user_id AS user_id, first_name, last_name, users.phone AS user_phone, email, start_service, finish_service " +
