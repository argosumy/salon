...
import spdu2022.java.project.beutysalon.logbookservices.persistence.mappers.ResultSetExtractorForLogServices;
import spdu2022.java.project.beutysalon.logbookservices.persistence.mappers.ResultSetExtractorForWorkingPeriod;
import spdu2022.java.project.beutysalon.logbookservices.persistence.mappers.ResultSetExtractorForWorkingWeekPeriod;
...
public class PersistenceLogBookRepository implements LogBookRepository {
    ...
    private static final String SELECT_LOG_SERVICE_BY_SALON_ID_AND_PERIOD =
            "SELECT salon_id, staff_id, log.user_id AS user_id, start_service, finish_service AS end_service " +
    ...
    private static final String SELECT_LOG_SERVICE_BY_CITY_AND_PERIOD =
            "SELECT salon_id, staff_id, log.user_id AS user_id, start_service, finish_service AS end_service " +
            "FROM log_book_services AS log " +
