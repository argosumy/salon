...
public class PersistenceLogBookRepository implements LogBookRepository{
    ...
    public PersistenceLogBookRepository(JdbcTemplate jdbcTemplate) {
    ...
    public List<Map<String, String>> getLogServiceByCityAndPeriod(String city, LocalDate startPeriod, LocalDate endPeriod) {
        ...
        return namedTemplate.query(SELECT_LOG_SERVICE_BY_CITY_AND_PERIOD, parameters, new ResultSetExtractorForLogServices());
    ...
    public List<Map<String, String>> getLogServiceBySalonIdAndPeriod(long salonId, LocalDate startPeriod, LocalDate endPeriod) {
        ...
        SqlParameterSource parameters = new MapSqlParameterSource()
                ...
                .addValue("startPeriod", startPeriod)
                .addValue("endPeriod", endPeriod);
        return namedTemplate.query(SELECT_LOG_SERVICE_BY_SALON_ID_AND_PERIOD, parameters, new ResultSetExtractorForLogServices());
    }
    ...
    public Map<Long, WorkingPeriod> getUniqWorkingMode(long salonId, LocalDate workDay) {
        ...
        return namedTemplate.query(SELECT_UNIQ_WORKING_MODE_BY_SALON_ID_AND_DAY, parameters, new ResultSetExtractorForWorkingPeriod());
    }
    ...
    public Map<Long, WorkingPeriod> getWeekWorkingMode(long salonId, LocalDate workDay) {
        ...
        SqlParameterSource parameters = new MapSqlParameterSource()
            ...
            return namedTemplate.query(SELECT_WORKING_MODE_WEEK_BY_SALON_ID, parameters, new ResultSetExtractorForWorkingPeriod());
    }

    @Override
    public WorkingPeriod findWorkingWeekPeriodBySalonIdAndDayOfWeek(long salonId, String dayOfWeek) {
       String SELECT_SALON_WORKING_WEEK_MODE_BY_SALON_ID_AND_WEEK_DAY = "SELECT * FROM salons_working_week_mode WHERE salon_id = ? AND day_week = ?";
       return jdbcTemplate.query(SELECT_SALON_WORKING_WEEK_MODE_BY_SALON_ID_AND_WEEK_DAY, (ResultSetExtractor<WorkingPeriod>) rs -> {
           ...
           if(rs.next()) {
               ...
               workingPeriod.setDaysOfWeek(DaysOfWeek.valueOf(rs.getString("day_week")));
           }
    ...
    public WorkingPeriod findWorkingDayPeriodBySalonIdAndDate(long salonId, LocalDate date) {
        ...
        return jdbcTemplate.query("SELECT * FROM salon_working_mode WHERE salon_id = ? AND start_working between ? AND ?",
        ...
        salonId, firstTimestamp, lastTimestamp);
    }
}